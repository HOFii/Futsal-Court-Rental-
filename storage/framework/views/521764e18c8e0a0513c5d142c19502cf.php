...
<html lang="en" dir="ltr">
  <head>
    ...
    <?php echo $__env->yieldContent("sc_header"); ?>
  </head>
  <body class="">
    <div class="page">
      <div class="flex-fill">
        <div class="header py-4">
          <div class="container">
            <div class="d-flex">
              <a class="header-brand" href="<?php echo e(route('user.home')); ?>">
                <img src="<?php echo e(asset('assets/images/logo.png')); ?>" class="header-brand-img" alt="tabler logo">
              </a>
              ...
              <div class="d-flex order-lg-2 ml-auto">                              
                <div class="dropdown d-none d-md-flex">
                  <a class="nav-link icon" data-toggle="dropdown">
                    ...
                    <?php if(config('app.notification_unread')): ?>
                      <span class="nav-unread"></span>
                    <?php endif; ?>
                  </a>
                  
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    <?php if(count(config('app.notification'))): ?>
                      <?php $__currentLoopData = config('app.notification'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <a href="<?php echo e(route('user.notification')); ?>" class="dropdown-item d-flex">
                      ...
                      <a href="<?php echo e(route('user.notification')); ?>" class="dropdown-item text-center">
                        Lihat Semuanya
                      </a>
                    <?php else: ?>
                ...
                <a class="nav-link icon d-block d-lg-none" href="<?php echo e(route('user.notification')); ?>">
                    <i class="fe fe-bell"></i>
                    <?php if(config('app.notification_unread')): ?>
                      <span class="nav-unread"></span>
                    <?php endif; ?>
                ...
                <div class="dropdown">
                  <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                    <span class="avatar" style="background-image: url(<?php echo e(asset('assets/images/users/'.auth()->user()->photo)); ?>)"></span>
            ...
            <div class="row align-items-center">             
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">                                  
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('user.product')); ?> " class="nav-link">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow">
                      <a href="<?php echo e(route('user.invoice')); ?>" class="dropdown-item">
                        Invoice
                      </a>   
                      <a href="<?php echo e(route('user.invoice.history')); ?>" class="dropdown-item">
                        Riwayat Invoice
                      </a>
                    </div>
                  </li>    
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('user.manual-payment')); ?>" class="nav-link">
    ...
    if ('serviceWorker' in navigator) {
      navigator.serviceWorker.register("<?php echo e(asset('assets/js/service-worker.js')); ?>")
      .then((registration) => {        
...
</html><?php /**PATH C:\Users\HOFi Desuka\LARAVEL\zbola\resources\views/user/layout/default.blade.php ENDPATH**/ ?>