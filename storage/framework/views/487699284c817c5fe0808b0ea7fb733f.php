    ...
    <div class="col-md-9 m-auto">
      <div class="row mt-5">
        ...
        <div class="col-md-5 mt-5 animated flipInX">
          ...
          <form class="mt-4" method="post" action="<?php echo e(route('signup')); ?>" id="form-signup">
            ...
            <div class="form-group">
              <a href="<?php echo e(route('signin')); ?>">Sudah punya akun</a>
            </div>
          </form>
        </div>
      </div>
...
</html><?php /**PATH C:\Users\HOFi Desuka\LARAVEL\zbola\resources\views/signup.blade.php ENDPATH**/ ?>