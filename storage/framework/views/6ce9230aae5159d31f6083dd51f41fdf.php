...
<?php $__env->startSection("content"); ?>
	<div class="container">
			...
			<div class="card-body">
				<div class="row">
					<div class='col-md-3 mb-3'>
						<img src="<?php echo e(asset('assets/images/products/'.$invoice->product->get_images[0])); ?>" 
							class="img-fluid">
					</div>
						...
						<div class="row">
							<div class="col-12">
								<div class="clearfix">
									<div class="float-left">
										<h4>
											<?php echo e(ucwords($invoice->product->address)); ?>
									...
									<div class="float-right">
										...
										<?php elseif($invoice->status == "running"): ?>
										 <span class="badge badge-warning">
										 	Berjalan
										 </span>
										<?php endif; ?>
							...
							<div class="col-12">
								<h5 class='text-success'>
									Rp.<?php echo e(number_format($invoice->product->price,2)); ?> Perjam
								</h5>
							</div>
						
							<div class="col-12 mt-2">
								<b>
									Total : Rp.<?php echo e(number_format($invoice->total,2)); ?> - (<?php echo e($invoice->hour); ?> Jam)
								</b>
							</div>
							...
							<div class="col-12 mt-5">
								<div class="clearfix">									
									<div class="float-left text-left">
										<b>
											Tanggal Mulai : <?php echo e($invoice->start_rent); ?>

										</b>
									</div>
									<div class="float-right">
										<b>
											Dibuat Pada : <?php echo e($invoice->created_at); ?>
			...
			<div class="card-body">
				...
				<div class="col-md-5 m-auto text-center">
					<button class="btn btn-danger mb-2"
						onclick="cancelOrder('<?php echo e(url('user/invoice/cancel')); ?>')">
		...
		<?php echo $__env->make("user.invoice.payment", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

		<?php echo $__env->make("user.invoice.running", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		...
		<div class="card">
			<div class="card-body">
				<div class="col-md-8 m-auto text-center">
					<img src="<?php echo e(asset('assets/images/invoice-404.png')); ?>"
						class="img-fluid">
...
<script>
	...
	function startTracking(){  
	  if("<?php echo e($invoice->status); ?>" == 'pending'){
	    var tommorow = moment("<?php echo e($expiredPayment); ?>").format('YYYY-MM-DD HH:mm:ss'); 
	    $("#note-invoice").html("* Note : Menunggu divalidasi admin");
	  }

	  if("<?php echo e($invoice->status); ?>" == 'payment'){
	    var tommorow = moment("<?php echo e($expiredPayment); ?>").format('YYYY-MM-DD HH:mm:ss');   
	    $("#note-invoice").html("* Note : Menunggu pembayaran dari user");    
	  }

	  if("<?php echo e($invoice->status); ?>" == 'waiting'){
	    var tommorow = moment("<?php echo e($invoice->start_rent); ?>").format('YYYY-MM-DD HH:mm:ss');   
	    $("#note-invoice").html("* Note : Menunggu hari H");  
	  }

	  if("<?php echo e($invoice->status); ?>" == 'running'){
	    var tommorow = moment("<?php echo e($endRent); ?>").format('YYYY-MM-DD HH:mm:ss');   
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("user.layout.default", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HOFi Desuka\LARAVEL\zbola\resources\views/user/invoice.blade.php ENDPATH**/ ?>